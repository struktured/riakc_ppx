...
module type S2 =
  sig
    module Key : Protobuf_capable.PBS2 (*Core.Std.String.t*)
    module Value : Protobuf_capable.S
    module Usermeta_value : Protobuf_capable.S
    module Index_value : Protobuf_capable.S
...
functor (Value : Protobuf_capable.S)(Default_usermeta : Protobuf_capable.S)(Default_index : Protobuf_capable.S) ->
module type of 
 *)
module Make :
